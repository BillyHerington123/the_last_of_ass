...
def open_records():
    ...
    try:
        ...
        if len(list_rec) == 0:
            ...
            player_1 = font.render(('Dungeon master: 0'), True, (255, 255, 255))
            player_2 = font.render(('Bos of the gym: 0'), True, (255, 25, 255))
            player_3 = font.render(('Boy next door: 0'), True, (255, 255, 25))
            player_4 = font.render(('Fucking slave: 0'), True, (255, 201, 14))
            player_5 = font.render(('Jabroni: 0'), True, (255, 0, 0))
        ...
        if len(list_rec) == 1:
            records_bg = pygame.transform.scale(load_image('records.jpg'), (width, height))
            screen.blit(records_bg, (0, 0))
            player_1 = font.render('Dungeon master: ' + str(list_rec[0]), True, (255, 255, 255))
            player_2 = font.render(('Bos of the gym: 0'), True, (255, 25, 255))
            player_3 = font.render(('Boy next door: 0'), True, (255, 255, 25))
            player_4 = font.render(('Fucking slave: 0'), True, (255, 201, 14))
            player_5 = font.render(('Jabroni: 0'), True, (255, 0, 0))
        ...
        if len(list_rec) == 2:
            ...
            screen.blit(records_bg, (0, 0))
            player_1 = font.render('Dungeon master: ' + str(list_rec[0]), True, (255, 255, 255))
            player_2 = font.render(('Bos of the gym: ' + str(list_rec[1])), True, (255, 25, 255))
            player_3 = font.render(('Boy next door: 0'), True, (255, 255, 25))
            player_4 = font.render(('Fucking slave: 0'), True, (255, 201, 14))
            player_5 = font.render(('Jabroni: 0'), True, (255, 0, 0))
            screen.blit(player_1, (30, 20))
        ...
        if len(list_rec) == 3:
            ...
            player_1 = font.render('Dungeon master: ' + str(list_rec[0]), True, (255, 255, 255))
            player_2 = font.render(('Bos of the gym: ' + str(list_rec[1])), True, (255, 25, 255))
            player_3 = font.render(('Boy next door: ' + str(list_rec[2])), True, (255, 255, 25))
            player_4 = font.render(('Fucking slave: 0'), True, (255, 201, 14))
            player_5 = font.render(('Jabroni: 0'), True, (255, 0, 0))
            screen.blit(player_1, (30, 20))
            screen.blit(player_2, (30, 50))
        ...
        if len(list_rec) == 4:
            ...
            player_2 = font.render(('Bos of the gym: ' + str(list_rec[1])), True, (255, 25, 255))
            player_3 = font.render(('Boy next door: ' + str(list_rec[2])), True, (255, 255, 25))
            player_4 = font.render(('Fucking slave: ' + str(list_rec[3])), True, (255, 201, 14))
            player_5 = font.render(('Jabroni: 0'), True, (255, 0, 0))
            screen.blit(player_1, (30, 20))
            screen.blit(player_2, (30, 50))
            screen.blit(player_3, (30, 80))
        ...
        if len(list_rec) == 5:
            ...
            player_3 = font.render(('Boy next door: ' + str(list_rec[2])), True, (255, 255, 25))
            player_4 = font.render(('Fucking slave: ' + str(list_rec[3])), True, (255, 201, 14))
            player_5 = font.render(('Jabroni: ' + str(list_rec[4])), True, (255, 0, 0))
...
pygame.display.set_caption('The last of ass')
    ...
    if Menu == True:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if height * 0.42 < event.pos[1] <= height * 0.49 and \
                        width * 0.28 < event.pos[0] < width * 0.72:
                    katit = True
                    Menu = False
                    play_sound()
                ...
                if height * 0.50 < event.pos[1] <= height * 0.57 and \
                        width * 0.28 < event.pos[0] < width * 0.72:
                    Menu = False
                    records = True
                ...
                if height * 0.57 < event.pos[1] <= height * 0.64 and \
                        width * 0.28 < event.pos[0] < width * 0.72:
                    settings = True
                    Menu = False
                ...
                if height * 0.64 < event.pos[1] <= height * 0.71 and \
                        width * 0.28 < event.pos[0] < width * 0.72:
                    terminate()
        pygame.display.flip()
